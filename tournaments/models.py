...
class Users_prueba(models.Model):
    ...
    tournament_id = models.ForeignKey(Tournament_prueba, verbose_name="ID del torneo que esta inscrito",on_delete=models.SET_NULL,
...
class Users_admin(admin.ModelAdmin):
    list_display = ('first_name', 'last_name', 'tournament_id')
